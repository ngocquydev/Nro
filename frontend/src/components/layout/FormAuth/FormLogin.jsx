...
function FormLogin() {
  ...
  const { authLogin, loading, handleLoginGoogle, handleLoginFB } = useContext(AuthContext);
        ...
        <Col xs={12} sm={10} md={8} lg={6}>
          <Card className="border-0 shadow">
            <Card.Body className="p-4">
              ...
              <Button className="my-3 w-100 p-2">
              ...
              <Row>
                <Col xs={6}>
                  <Button variant="danger" className="w-100" onClick={onGoogleClick}>
                    <FaGoogle /> Google
                  </Button>
                </Col>

                <Col xs={6}>
                  <Button variant="primary" className="w-100" onClick={onFacebookClick}>
